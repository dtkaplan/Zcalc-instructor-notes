...
date: "US Naval Academy Feb 11, 2022"
...
That is, the computational techniques used in applications of calculus
    
- Small, enumerated set of calculus operations: "something you do to a function."
    - function evaluation, differentiation, anti-differentiation, solving, argmax, iteration.
...
- $\text{one}()\ \ \ \ \ \text{identity}()\ \ \ \ \  \text{recip}()$
- Exponential: $e^x$ &  Logarithm: $\ln()$
- Power-law: $x^p$
- Sinusoid: $\sin()$ 
- Gaussian: $\text{dnorm}()$
- Sigmoid: $\text{pnorm}()$
